              ...
              >
                <div className='container'>
                  <div className='hero-content'>
                    <motion.span
                      className='text-primary mb-[5px] block font-medium'
                    ...
                    />
                    <motion.h2
                      className='after:bg-primary relative mb-[30px] pb-[15px] text-[34px] leading-[1.1] after:absolute after:bottom-0 after:left-0 after:max-h-[4px] after:min-h-[4px] after:min-w-[70px] after:max-w-[70px] md:text-[60px]'
                      dangerouslySetInnerHTML={{
