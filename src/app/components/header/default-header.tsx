...
import Navigation from '@/app/components/header/components/elements/Navigation'
...
const Header = ({ aboutOverlay = false }: { aboutOverlay: boolean }) => {
      ...
      >
        <Container className="wide">
          ...
          <Row className="multilevel-header__bottom">
            <Col lg={12} className="text-center d-none d-lg-block space-mt--40">
              {/* navigation */}
              <Navigation />
            </Col>
          </Row>
