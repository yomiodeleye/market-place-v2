...
import NavigationOverlay from '@/app/components/header/elements/NavigationOverlay'
...
const HeaderThree = () => {
  ...
  const [offCanvasNavigationActive, setOffCanvasNavigationActive] =
    useState(false)
      ...
      >
        <Container className="wide">
          <Row className="header-content align-items-center space-pt--30 space-pb--30">
            ...
            <Col xs={6} lg={4}>
              <div className="header-content__logo text-start text-lg-center">
                <Anchor path="/">
                  <img
            ...
            <Col xs={6} lg={4}>
              <div className="header-content__icons text-end">
